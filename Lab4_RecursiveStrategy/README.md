...
1. The long long int can be used to help compute larger factorials. This allocates double the amount of memory than the averge int data type, going from 4 bits to 8 bits.

2. My computer was slowing down when calculating 25!, but started to crash or severely lag after 30!.
